...
1) Programmu palaiž caur komandrindiņu un lietotājs atlasa darbības opciju un faila nosaukumu, no kā tiks ielādēta informācija.

2) Pēc uzdevuma izpildīšanas...

----
Iekļautie piemēri mapē 'input':
	- input_01.json - Ievades fails pirmajam uzdevuma solim. Apraksta sertifikāta saturu. Šis fails tiek glabāts JSON formātā.
	- input_02.txt - Otrajam solim.
	- input_03.txt - Trešajam solim.